...
(function() {
  ...
  changeFont = function(ratioDiff, notification) {
    ...
    if (notification) {
      setTimeout(function() {
        return notie.alert(4, "Text Zoom " + ((totalRatio * 100).toFixed()) + "%", 2);
      });
    }
    if (totalRatio === 1) {
