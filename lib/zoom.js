...
(function() {
  ...
  changeFont = function(ratioDiff, notification) {
    var call, changeFontSizeCalls, relevantElements, timeout, _i, _len, _results;
    ...
    _.each(relevantElements, function(element) {
      ...
      if (Util.isBlank(element.innerText) && !(element.tagName.match(/INPUT|TEXTAREA/))) {
        return;
      }
