...
(function() {
  var ZOOM_LEVEL_KEY, changeFont, getKeyFromBackground, ignore, pixelValue, totalRatio, zoomLevel;
  ...
  changeFont = function(ratioDiff, notification) {
    ...
    _.each(relevantElements, function(element) {
      var fontSize, lineHeight, tagName;
      tagName = element.tagName;
      if (Util.isBlank(element.innerText) && !(tagName.match(/INPUT|TEXTAREA/))) {
        return;
      }
