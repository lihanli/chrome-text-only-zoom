...
(function() {
  var ZOOM_LEVEL_KEY, changeFont, getKeyFromBackground, ignoredTags, pixelValue, totalRatio, zoomLevel;

  totalRatio = 1;

  ZOOM_LEVEL_KEY = 'zoomLevel';

  ignoredTags = ['html', 'head', 'title', 'meta', 'script', 'noscript', 'link', 'br', 'embed', 'iframe', 'img', 'video', 'canvas'];
  ...
  changeFont = function(ratioDiff, notification) {
    var call, changeFontSizeCalls, relevantElements, _i, _len, _results;
    ...
    relevantElements.each(function() {
      var element, fontSize, lineHeight,
        _this = this;
      element = $(this);
      if (element.text() === '' && !element.is('input, textarea')) {
        return;
      }
      ...
      return changeFontSizeCalls.push(function() {
        $(_this).css('font-size', pixelValue(fontSize));
        if (lineHeight != null) {
          return $(_this).css('line-height', pixelValue(lineHeight));
        }
      });
    });
    _results = [];
    for (_i = 0, _len = changeFontSizeCalls.length; _i < _len; _i++) {
      call = changeFontSizeCalls[_i];
      _results.push(call());
    }
    return _results;
  };
  ...
  getKeyFromBackground(Util.ZOOM_IN_KEY, function() {
    return changeFont(0.1);
  });

  getKeyFromBackground(Util.ZOOM_OUT_KEY, function() {
    return changeFont(-0.1);
  });

  getKeyFromBackground(Util.ZOOM_RESET_KEY, function() {
    totalRatio = 1;
    return changeFont(0);
  });
